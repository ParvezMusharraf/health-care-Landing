...
(function () {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // Listen for input changes and update variables
    ...
    doctorInput.addEventListener("change", (event) => {
    ...
    form.addEventListener("submit", (event) => {
      ...
      // You can add logic to send the data to the server via AJAX if needed
    });
  });
